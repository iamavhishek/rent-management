...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,address,unitNumber,securityDeposit,ownerName,ownerPhone,createdAt,updatedAt,isActive);

@override
String toString() {
  return 'PropertyModel(id: $id, name: $name, address: $address, unitNumber: $unitNumber, securityDeposit: $securityDeposit, ownerName: $ownerName, ownerPhone: $ownerPhone, createdAt: $createdAt, updatedAt: $updatedAt, isActive: $isActive)';
}
...
@useResult
$Res call({
@HiveField(0) String id,@HiveField(1) String name,@HiveField(2) String address,@HiveField(3) String unitNumber,@HiveField(5) double securityDeposit,@HiveField(6) String ownerName,@HiveField(7) String ownerPhone,@HiveField(13) DateTime createdAt,@HiveField(14) DateTime updatedAt,@HiveField(15) bool isActive
});
...
/// Create a copy of PropertyModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? address = null,Object? unitNumber = null,Object? securityDeposit = null,Object? ownerName = null,Object? ownerPhone = null,Object? createdAt = null,Object? updatedAt = null,Object? isActive = null,}) {
...
as String,securityDeposit: null == securityDeposit ? _self.securityDeposit : securityDeposit // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HiveField(0)  String id, @HiveField(1)  String name, @HiveField(2)  String address, @HiveField(3)  String unitNumber, @HiveField(5)  double securityDeposit, @HiveField(6)  String ownerName, @HiveField(7)  String ownerPhone, @HiveField(13)  DateTime createdAt, @HiveField(14)  DateTime updatedAt, @HiveField(15)  bool isActive)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PropertyModel() when $default != null:
return $default(_that.id,_that.name,_that.address,_that.unitNumber,_that.securityDeposit,_that.ownerName,_that.ownerPhone,_that.createdAt,_that.updatedAt,_that.isActive);case _:
  return orElse();
...
class _PropertyModel extends PropertyModel {
  const _PropertyModel({@HiveField(0) required this.id, @HiveField(1) required this.name, @HiveField(2) required this.address, @HiveField(3) required this.unitNumber, @HiveField(5) required this.securityDeposit, @HiveField(6) required this.ownerName, @HiveField(7) required this.ownerPhone, @HiveField(13) required this.createdAt, @HiveField(14) required this.updatedAt, @HiveField(15) required this.isActive}): super._();
...
/// Create a copy of PropertyModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? address = null,Object? unitNumber = null,Object? securityDeposit = null,Object? ownerName = null,Object? ownerPhone = null,Object? createdAt = null,Object? updatedAt = null,Object? isActive = null,}) {
