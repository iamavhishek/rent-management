...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,phone,propertyId,moveInDate,citizenshipNumber,createdAt,updatedAt,isActive,leaseEndDate,citizenshipImagePath,electricityRate,waterRate,initialElectricityReading,initialWaterReading,leftDate,monthlyRent);

@override
String toString() {
  return 'TenantModel(id: $id, name: $name, phone: $phone, propertyId: $propertyId, moveInDate: $moveInDate, citizenshipNumber: $citizenshipNumber, createdAt: $createdAt, updatedAt: $updatedAt, isActive: $isActive, leaseEndDate: $leaseEndDate, citizenshipImagePath: $citizenshipImagePath, electricityRate: $electricityRate, waterRate: $waterRate, initialElectricityReading: $initialElectricityReading, initialWaterReading: $initialWaterReading, leftDate: $leftDate, monthlyRent: $monthlyRent)';
}
