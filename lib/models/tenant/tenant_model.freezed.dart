...
@HiveField(0) String get id;@HiveField(1) String get name;@HiveField(2) String get phone;@HiveField(4) String get propertyId;@HiveField(5) DateTime get moveInDate;@HiveField(9) String get citizenshipNumber;@HiveField(11) DateTime get createdAt;@HiveField(12) DateTime get updatedAt;@HiveField(13) bool get isActive;@HiveField(6) DateTime? get leaseEndDate;@HiveField(10) String? get citizenshipImagePath;@HiveField(14) double get electricityRate;@HiveField(15) double get waterRate;@HiveField(16) double get initialElectricityReading;@HiveField(17) double get initialWaterReading;@HiveField(18) DateTime? get leftDate;@HiveField(19) double get monthlyRent;@HiveField(20) double get securityDeposit;
...
@useResult
$Res call({
@HiveField(0) String id,@HiveField(1) String name,@HiveField(2) String phone,@HiveField(4) String propertyId,@HiveField(5) DateTime moveInDate,@HiveField(9) String citizenshipNumber,@HiveField(11) DateTime createdAt,@HiveField(12) DateTime updatedAt,@HiveField(13) bool isActive,@HiveField(6) DateTime? leaseEndDate,@HiveField(10) String? citizenshipImagePath,@HiveField(14) double electricityRate,@HiveField(15) double waterRate,@HiveField(16) double initialElectricityReading,@HiveField(17) double initialWaterReading,@HiveField(18) DateTime? leftDate,@HiveField(19) double monthlyRent,@HiveField(20) double securityDeposit
});
...
/// Create a copy of TenantModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? phone = null,Object? propertyId = null,Object? moveInDate = null,Object? citizenshipNumber = null,Object? createdAt = null,Object? updatedAt = null,Object? isActive = null,Object? leaseEndDate = freezed,Object? citizenshipImagePath = freezed,Object? electricityRate = null,Object? waterRate = null,Object? initialElectricityReading = null,Object? initialWaterReading = null,Object? leftDate = freezed,Object? monthlyRent = null,Object? securityDeposit = null,}) {
...
as bool,leaseEndDate: freezed == leaseEndDate ? _self.leaseEndDate : leaseEndDate // ignore: cast_nullable_to_non_nullable
as DateTime?,citizenshipImagePath: freezed == citizenshipImagePath ? _self.citizenshipImagePath : citizenshipImagePath // ignore: cast_nullable_to_non_nullable
as String?,electricityRate: null == electricityRate ? _self.electricityRate : electricityRate // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HiveField(0)  String id, @HiveField(1)  String name, @HiveField(2)  String phone, @HiveField(4)  String propertyId, @HiveField(5)  DateTime moveInDate, @HiveField(9)  String citizenshipNumber, @HiveField(11)  DateTime createdAt, @HiveField(12)  DateTime updatedAt, @HiveField(13)  bool isActive, @HiveField(6)  DateTime? leaseEndDate, @HiveField(10)  String? citizenshipImagePath, @HiveField(14)  double electricityRate, @HiveField(15)  double waterRate, @HiveField(16)  double initialElectricityReading, @HiveField(17)  double initialWaterReading, @HiveField(18)  DateTime? leftDate, @HiveField(19)  double monthlyRent, @HiveField(20)  double securityDeposit)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TenantModel() when $default != null:
return $default(_that.id,_that.name,_that.phone,_that.propertyId,_that.moveInDate,_that.citizenshipNumber,_that.createdAt,_that.updatedAt,_that.isActive,_that.leaseEndDate,_that.citizenshipImagePath,_that.electricityRate,_that.waterRate,_that.initialElectricityReading,_that.initialWaterReading,_that.leftDate,_that.monthlyRent,_that.securityDeposit);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HiveField(0)  String id, @HiveField(1)  String name, @HiveField(2)  String phone, @HiveField(4)  String propertyId, @HiveField(5)  DateTime moveInDate, @HiveField(9)  String citizenshipNumber, @HiveField(11)  DateTime createdAt, @HiveField(12)  DateTime updatedAt, @HiveField(13)  bool isActive, @HiveField(6)  DateTime? leaseEndDate, @HiveField(10)  String? citizenshipImagePath, @HiveField(14)  double electricityRate, @HiveField(15)  double waterRate, @HiveField(16)  double initialElectricityReading, @HiveField(17)  double initialWaterReading, @HiveField(18)  DateTime? leftDate, @HiveField(19)  double monthlyRent, @HiveField(20)  double securityDeposit)  $default,) {final _that = this;
switch (_that) {
case _TenantModel():
return $default(_that.id,_that.name,_that.phone,_that.propertyId,_that.moveInDate,_that.citizenshipNumber,_that.createdAt,_that.updatedAt,_that.isActive,_that.leaseEndDate,_that.citizenshipImagePath,_that.electricityRate,_that.waterRate,_that.initialElectricityReading,_that.initialWaterReading,_that.leftDate,_that.monthlyRent,_that.securityDeposit);case _:
  throw StateError('Unexpected subclass');
...
class _TenantModel extends TenantModel {
  const _TenantModel({@HiveField(0) required this.id, @HiveField(1) required this.name, @HiveField(2) required this.phone, @HiveField(4) required this.propertyId, @HiveField(5) required this.moveInDate, @HiveField(9) required this.citizenshipNumber, @HiveField(11) required this.createdAt, @HiveField(12) required this.updatedAt, @HiveField(13) required this.isActive, @HiveField(6) this.leaseEndDate, @HiveField(10) this.citizenshipImagePath, @HiveField(14) this.electricityRate = 0, @HiveField(15) this.waterRate = 0, @HiveField(16) this.initialElectricityReading = 0, @HiveField(17) this.initialWaterReading = 0, @HiveField(18) this.leftDate, @HiveField(19) this.monthlyRent = 0, @HiveField(20) this.securityDeposit = 0}): super._();
...
@override@JsonKey()@HiveField(20) final  double securityDeposit;
...
/// Create a copy of TenantModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? phone = null,Object? propertyId = null,Object? moveInDate = null,Object? citizenshipNumber = null,Object? createdAt = null,Object? updatedAt = null,Object? isActive = null,Object? leaseEndDate = freezed,Object? citizenshipImagePath = freezed,Object? electricityRate = null,Object? waterRate = null,Object? initialElectricityReading = null,Object? initialWaterReading = null,Object? leftDate = freezed,Object? monthlyRent = null,Object? securityDeposit = null,}) {
