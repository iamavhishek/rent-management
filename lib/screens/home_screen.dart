...
class _StatTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) => LayoutBuilder(
    builder: (BuildContext context, BoxConstraints constraints) {
      ...
      final bool isNarrow = cardWidth < 80;
      final bool isMedium = cardWidth >= 80 && cardWidth < 140;
      final double iconSize = isNarrow ? 14 : (isMedium ? 16 : 18);
      final double iconBox = isNarrow ? 28 : (isMedium ? 32 : 36);
      final double valueSize = isNarrow ? 13 : (isMedium ? 16 : 18);
      final double labelSize = isNarrow ? 9 : (isMedium ? 10 : 11);
      final double pad = isNarrow ? 8 : (isMedium ? 10 : 12);
      final double radius = isNarrow ? 10 : (isMedium ? 14 : 16);
